...
## Project Structure
    ...
    ├── getting_started_dem_37304  # Django project configurations
...
1. Clone this repo and `cd getting_started_dem_37304`
...
2. Clone this repo and `cd getting_started_dem_37304`
